...
<p>User проходит registration и login flow,получает JWt access token,c которым может делать запросы на защищенные эндпоинты</p>
<p>Так же User может получить права супер админа ,c которыми он может видеть  редактировать , удалять  и видеть не свои контакты</p>
